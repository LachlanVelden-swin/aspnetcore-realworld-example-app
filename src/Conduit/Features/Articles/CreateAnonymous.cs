    ...
    public class CreateAnonymous
    {
        ...
        public class Handler : IRequestHandler<Command, ArticleEnvelope>
        {
            ...
            public async Task<ArticleEnvelope> Handle(Command message, CancellationToken cancellationToken)
            {
                ...
                if (author != null) 
                    throw new ValidationException("Username is registered, please use an Anonymous username.");
                author = new Person() { Username = message.Username };
                _context.Persons.Add(author);
